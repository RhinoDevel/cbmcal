...
1090 YE=2024:MO=3:DA=0:REM DATE AS INTS.
...
1245 REM TITLE ROW (THE WEEKDAYS):
1250 PRINT " ";
1260 FOR I=0 TO 5
1270 PRINT WD$(I);"  ";
1280 NEXT I
1290 PRINT WD$(6)
1295 REM 1ST (MAYBE INCOMPL.) DAY ROW:
1300 PRINT " ";
1310 FOR I=0 TO 5
1320 IF I>=WD THEN 1340
1330 PRINT "   ";:GOTO 1350
1340 PRINT I-WD+1;" ";
1350 NEXT I
1360 PRINT I-WD+1;" "
1365 REM FOLLOWING (COMPLETE) DAY ROWS:
1370 B0=I-WD+1+1
1380 B1=MD(MO-1)
